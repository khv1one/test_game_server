...
object GameHandler {
  ...
  ) extends GameHandler[F, OneCardGame[F]](gameLobby, sessionRepo)
  ...
  object OneCard {
    def apply[F[_] : Async : Parallel](
      ...
      ).parTupled.map { case (lobby, sessionRepo) => new OneCard[F](lobby, sessionRepo) }
    }
  }
  ...
  ) extends GameHandler[F, TwoCardGame[F]](gameLobby, sessionRepo)
  ...
  object TwoCard {
    def apply[F[_] : Async : Parallel](
      ...
      ).parTupled.map { case (lobby, sessionRepo) => new TwoCard[F](lobby, sessionRepo) }
    }
  }
  ...
  ) extends GameHandler[F, SimpleDiceGame[F]](gameLobby, sessionRepo)
  ...
  object SimpleDice {
    def apply[F[_] : Async : Parallel](
      ...
      ).parTupled.map { case (lobby, sessionRepo) => new SimpleDice[F](lobby, sessionRepo) }
    }
  }
}
